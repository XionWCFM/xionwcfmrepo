...
const spacing = {
  ...
  "28": "calc(var(--spacing) * 14)",
  "32": "calc(var(--spacing) * 16)",
  "36": "calc(var(--spacing) * 18)",
  "40": "calc(var(--spacing) * 20)",
  "44": "calc(var(--spacing) * 22)",
  "48": "calc(var(--spacing) * 24)",
  "64": "calc(var(--spacing) * 32)",
  "76": "calc(var(--spacing) * 38)",
  "88": "calc(var(--spacing) * 44)",
  "100": "calc(var(--spacing) * 50)",
  "128": "calc(var(--spacing) * 64)",
  "256": "calc(var(--spacing) * 128)",
  "384": "calc(var(--spacing) * 192)",
