...
import { AUTHOR_NAME, BASE_SITE_NAME, BASE_SITE_URL, BASE_TEMPLETE_TITLE } from "../constants";
...
export const createMetadata = (param: CreateMetadataParamsType): Metadata => {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `${BASE_SITE_URL}/opengraph-image.jpg`, alt: "About XionWCFM OG IMAGE" }],
    },
    twitter: {
      creator: authors,
      card: "summary",
      ...
      title,
      description,
      images: [{ url: `${BASE_SITE_URL}/twitter-image.jpg`, alt: "About XionWCFM OG IMAGE" }],
    },
    robots: {
      index,
      follow,
