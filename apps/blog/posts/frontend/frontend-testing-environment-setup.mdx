...
description: 프론트엔드 테스팅 환경을 구성하는것은 상당히 정신건강을 해치는 작업 중 하나입니다. 그래도 다행인 점은 시간이 지나면서 outdated 되는 정보도 있을 수 있지만 환경설정을 하는데에 큰 틀은 보통 바뀌지 않는 것 같아요 또 하다보면 꼭 필요하지만 기억이 잘 안나는 설정들이 존재하는데요 그런 세부적인 디테일들을 한곳에 정리해보았습니다.
thumbnail: fallback
categories: next
writeDate: 2024-06-15T08:29:07.053Z
releaseDate: 2024-06-16T17:44:00.053Z
canView: true
authority: public
---
